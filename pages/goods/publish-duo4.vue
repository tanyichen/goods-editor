<template>
    <view class="uni-page-body" style="box-sizing: border-box;">
        <view v-if="showImageCut">
            <image-cut ref="imageCut" :imgSrc="form.image" @changes="imagecChanges"></image-cut>
        </view>
      ...
      stock: '10'
        ...
        methods: {
            imagecChanges(e){
              // console.log(e)
              if(e){
                this.form.image=e.tempFilePath;                
              }
                              this.tapImage();

            },
           tapImage(){
               this.showImageCut=!this.showImageCut
           },
            // 三级联动选择
            ...
            send() {
                ...
                if(this.form.image!=rawData.image){
                   var imgList =  [this.form.image]
                   if (this.isYasuo) {
